...
def train_ce(train_dataset:str,val_dataset:str,model,output_path,train_loss,evaluator,margin,learning_rate,batch_size,warmup_ratio,num_epochs,
             text_col="DetailsofViolation",class_col="NOVCodeDescription",train_neg_ratio:Optional[int] = "Follow Bi-Encoder"):
